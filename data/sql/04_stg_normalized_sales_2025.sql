-- ======================================================
--        STAGING LAYER (STG) – SALES NORMALIZATION
-- ======================================================
-- Purpose:
-- Store typed and cleaned sales data ready for analytics.
--
-- Description:
-- This layer consolidates RAW monthly sales data (CSV-based)
-- and applies data cleaning, normalization, and type casting.
--
-- Source:
-- raw.ventas_2025_01_raw
