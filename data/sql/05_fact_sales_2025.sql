-- =====================================================================
-- File:        05_fact_ventas_2025.sql
-- Project:     Andes Retail - SQL Analytics
-- Description: Creates the FACT sales table at transaction level and
--              enriches each sale with calculated financial metrics
--              such as gross sales, costs, gross profit, operating
--              profit, taxes, and net profit for KPI analysis.
-- Grain:       One row per sale (transaction level)
-- Source:      stg.ventas_2025
