...
-- Layer: FACT (Analytical KPIs)
-- Description:
--   Definition of financial, commercial and operational KPI views
--   at monthly level, based on fact.ventas_2025 table.
--
-- Conventions:
--   - Absolute metrics expressed in monetary values
--   - Percentage KPIs expressed as %
--   - Division by zero protected using NULLIF
-- =============================================================================
